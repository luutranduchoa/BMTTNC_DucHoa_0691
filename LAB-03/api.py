...
# Khởi tạo đối tượng ECC (đặt cùng chỗ với rsa_cipher)
...
def ecc_sign_message():
    ...
    # Tải khóa riêng tư để thực hiện ký
...
def ecc_verify_signature():
    ...
    # Tải khóa công khai để xác thực
    public_key, _ = ecc_cipher.load_keys()
    
    # Chuyển đổi chữ ký từ dạng Hex về bytes
    signature = bytes.fromhex(signature_hex)
